...
CREATE OR REPLACE PROCEDURE SP_Flex_Ini_Copy_Sources_CC()
    RETURNS VARCHAR
    LANGUAGE SQL
    EXECUTE AS OWNER
AS
...
=========================================================================
                                HISTORY
=========================================================================
Description : Create Procedure Script For Copy Source Scneario From CC to W_FLX_SRC_SCE 
...
BEGIN
    ...
    CALL COP_DMT_FLX.SP_T_FLX_FLW_RUN_LOG_INIT(:V_RUN_ID,'COP_DMT_FLX','SP_Flex_Ini_Copy_Sources_CC','#','DLT',CURRENT_USER);

    -- 1. Retrieve Source scenarios data from Controlling Cloud (copy at lowest level, will be used for disaggregation)

    -- Assign the step name, step num and start date of the step
    v_STEP_TABLE := 'INSERT CC Source Scenario INTO W_FLX_SRC_SCE';
