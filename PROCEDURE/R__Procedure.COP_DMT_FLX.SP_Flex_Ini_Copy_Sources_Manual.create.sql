...
=========================================================================
                                          HISTORY
=========================================================================
DESCRIPTION : CREATE PROCEDURE SCRIPT FOR COPY MANUAL DATASET TO W_FLX_SRC_SCE__CLC 
...
CREATE OR REPLACE PROCEDURE SP_Flex_Ini_Copy_Sources_Manual()
    RETURNS VARCHAR
    LANGUAGE SQL
    EXECUTE AS OWNER
AS
...
BEGIN
    ...
    CALL COP_DMT_FLX.SP_T_FLX_FLW_RUN_LOG_INIT(:V_RUN_ID,'COP_DMT_FLX','SP_Flex_Ini_Copy_Sources_Manual','#','DLT',CURRENT_USER);
    ...
    v_STEP_TABLE := 'INSERT INTO W_FLX_SRC_SCE__CLC FROM V_ETL_F_FLX_MAN_SCE_FLT';
