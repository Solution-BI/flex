...
CREATE OR REPLACE TRANSIENT TABLE W_FLX_CMP_SCE
(         CBU_COD                         VARCHAR(10)
         ...
         ) DATA_RETENTION_TIME_IN_DAYS = 0 COMMENT = '[Flex] Working table Controling cloud Comparable & Actual scenario used for the aggegation process';
