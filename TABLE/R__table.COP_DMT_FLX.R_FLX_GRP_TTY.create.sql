...
CREATE OR REPLACE TABLE R_FLX_GRP_TTY 
         (CBU_COD             VARCHAR(10)                             COMMENT 'CBU/Market'
         ,TTY_ELM_COD         VARCHAR(30)                             COMMENT 'Territory code'
         ,TTY_DIM_GRP_COD     NUMBER(10,0)                            COMMENT 'Agg level ID'
         ,TTY_GRP_COD         VARCHAR(30)                             COMMENT 'Agg level element code'
         ,TTY_GRP_DSC         VARCHAR(500)                            COMMENT 'Agg level element name'
         ...
         ,CONSTRAINT PK_R_FLX_GRP_TTY PRIMARY KEY (CBU_COD, TTY_ELM_COD, TTY_DIM_GRP_COD)
         ) COMMENT = '[Flex] Territory aggregation levels';
