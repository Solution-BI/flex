...
CREATE OR REPLACE TRANSIENT TABLE W_FLX_SRC_SCE__CLC
         (CBU_COD                             VARCHAR(30)
         ...
         ) DATA_RETENTION_TIME_IN_DAYS = 0 COMMENT = '[Flex] Source scenario Working table used for the aggegation process';
