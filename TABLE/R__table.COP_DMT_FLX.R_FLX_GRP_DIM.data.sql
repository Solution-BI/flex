...
/*----------------------------INFO---------------------------------------------*/
/* Name : R_FLX_GRP_DIM                                                        */
/* Date Created (dd-mm-yy): 26-11-2024                                         */
/* Owner: Controlling Cloud                                                    */
/* Modifications :                                                             */
/* 30-05-2025 MSH : T-115 - add segment info in as su_sp_split_code (reused)   */
/* ----------------------------------------------------------------------------*/

DELETE FROM R_FLX_GRP_DIM;
...
--         ,('ETI',  2, 'Market'      ,  0, current_timestamp, current_timestamp)
         ...
         ,('PDT',  103, 'L3 Sub-Brand'          ,  0, current_timestamp, current_timestamp)
          ...
          -- EIB (Business Type)
         ,('EIB', -1, 'Total Business Type',  0, current_timestamp, current_timestamp)
         ,('EIB',  0, 'EIB'      ,  0, current_timestamp, current_timestamp)
          
          -- Managerial/L500
         ,('CAT_TYP', -1, 'IFRS'                          ,  0, current_timestamp, current_timestamp)
         ,('CAT_TYP',  0, 'Managerial/Internal Transfers' ,  0, current_timestamp, current_timestamp)
         ...
         ,('TTY',  0, 'Territory'      ,  0, current_timestamp, current_timestamp)
          ...
          -- SU/SP Split
         ,('SAL_SUP', -1, 'Total Organisation & Segment'        ,  0, current_timestamp, current_timestamp)
         ,('SAL_SUP',  0, 'Organisation & Segment Split (LL)'   ,  0, current_timestamp, current_timestamp)
