...
CREATE OR ALTER TABLE F_FLX_SCE_IND 
         ...
         ,FLX_SRC_CUR_VAL         NUMBER(32,12)                           COMMENT 'Indicator amount from the source scenario'
         ,FLX_CMP_ACT_CUR_VAL     NUMBER(32,12)                           COMMENT 'Indicator amount from the Actual scenario'
         ,FLX_CMP_1ST_CUR_VAL     NUMBER(32,12)                           COMMENT 'Indicator amount from the first comparable scenario'
         ,FLX_CMP_2ND_CUR_VAL     NUMBER(32,12)                           COMMENT 'Indicator amount from the second comparable scenario'
         ,FLX_CMP_3RD_CUR_VAL     NUMBER(32,12)                           COMMENT 'Indicator amount from the third comparable scenario'
         ...
         ,CONSTRAINT PK_F_FLX_SCE_IND PRIMARY KEY (SCE_ELM_COD, PER_GRP_COD, ETI_GRP_COD, CUS_GRP_COD, PDT_GRP_COD, EIB_GRP_COD, CAT_GRP_COD, TTY_GRP_COD, CUR_COD, IND_ELM_COD)
         ) COMMENT = '[Flex] Flex scenarios';
